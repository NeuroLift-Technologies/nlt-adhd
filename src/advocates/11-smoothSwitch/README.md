# 11-smoothSwitch — SmoothSwitch — Task Switching

> **Trait:** SmoothSwitch — Task Switching
> **Status:** Stub — TODO (all 20 present, 6 MVP are fully wired; 14 are stubs)

- **Stub:** `src/advocates/11-smoothSwitch/index.ts` — empty with TODO, no model weights
- **Upstream trait catalog:** [neurolift-ai-fusion](https://github.com/NeuroLift-Technologies/neurolift-ai-fusion) — `src/advocates/11-smoothSwitch` (canonical — not vendored here)
