# 17-sensorySeeker — SensorySeeker — Sensory Seeking

> **Trait:** SensorySeeker — Sensory Seeking
> **Status:** Stub — TODO (all 20 present, 6 MVP are fully wired; 14 are stubs)

- **Stub:** `src/advocates/17-sensorySeeker/index.ts` — empty with TODO, no model weights
- **Upstream trait catalog:** [neurolift-ai-fusion](https://github.com/NeuroLift-Technologies/neurolift-ai-fusion) — `src/advocates/17-sensorySeeker` (canonical — not vendored here)
