# 15-socialSync — SocialSync — Social Cognition

> **Trait:** SocialSync — Social Cognition
> **Status:** Stub — TODO (all 20 present, 6 MVP are fully wired; 14 are stubs)

- **Stub:** `src/advocates/15-socialSync/index.ts` — empty with TODO, no model weights
- **Upstream trait catalog:** [neurolift-ai-fusion](https://github.com/NeuroLift-Technologies/neurolift-ai-fusion) — `src/advocates/15-socialSync` (canonical — not vendored here)
