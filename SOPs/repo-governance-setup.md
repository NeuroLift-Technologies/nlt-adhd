...
| `REVIEW.md` | Canonical agent review format (synced from `.github-private`) |
...
4. Project context: `docs/context/README_TO_AI.md` (this repo, if present)
5. Active threads: `docs/active-threads.md` (this repo)
