...
This namespace contains internal governance artifacts for the `NeuroLift-Technologies/nlt-adhd` repository.
...
This script checks that all required governance files exist and contain expected content markers. Includes App Decoupling check (src/ must not import archived World/Fusion) and no-archive check.
